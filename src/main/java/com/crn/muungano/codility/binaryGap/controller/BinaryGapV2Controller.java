...
import com.crn.muungano.codility.binaryGap.service.BinaryGapServiceV2;
...
@Slf4j
@RestController
@RequestMapping(path = "/binary/gap/v2")
public class BinaryGapV2Controller {
    /*
     ...
     */
    BinaryGapServiceV2 serviceV2;

    public BinaryGapV2Controller(BinaryGapServiceV2 serviceV2) {
        this.serviceV2 = serviceV2;
    }

    @PostMapping(path = "/test")
    public ResponseEntity<?> processBinaryGapResquest(@Valid @RequestBody BinaryGapRequestV2DTO request){
        BinaryGapResponseV2DTO response = serviceV2.processBinaryGap(request);
